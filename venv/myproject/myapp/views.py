...
def addemployee(request):
    ...
    if emp_code:
        ...
        attendance_count = AttendanceCount.objects.get(EmpCode_id=employee)

        context['getVlSl'] = {
           
            'Vacation': attendance_count.Vacation,
            'Sick': attendance_count.Sick,
        }
